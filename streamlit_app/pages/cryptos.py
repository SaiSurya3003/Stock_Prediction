...
def fetch_crypto_data():
    url = "https://api.coingecko.com/api/v3/coins/markets" #URL used to get Data
    params = {
        'vs_currency': 'usd',
    ...
    data = response.json() #moving the data into json which could be easy to operate
    return data
...
def app():
    st.title("Streamlit Cryptos Dashboard")
